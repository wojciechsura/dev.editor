...
{
    internal class TextDocumentPropertyNotNullCondition<TProp> : BaseCondition
    {
        private readonly DocumentsManager documentsManager;
        private readonly bool defaultValue;
        private readonly string valuePropertyName;
        private readonly Func<TextDocumentViewModel, TProp> getValueFunc;
        ...
        public TextDocumentPropertyNotNullCondition(DocumentsManager documentsManager, Expression<Func<TextDocumentViewModel, TProp>> getValueExpression, bool defaultValue)
        {
